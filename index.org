...
*** Aug 2020 • 5 mos 
    ...
    :END:
    + (ongoing) Development and maintenance of self-service Apache NiFi platform based on *EKS*, *AWS* using *Terraform*, *Helm*, *Prometheus*, *K8S Operators*, *Maven*, *Jenkins*
    + (ongoing) Working directly with customers as a L1 support
